...
GameScene::GameScene(std::string name, cg3d::Display* display) : SceneWithImGui(std::move(name), display)
{
...
void GameScene::Update(const cg3d::Program& program, const Eigen::Matrix4f& proj, const Eigen::Matrix4f& view, const Eigen::Matrix4f& model)
{

}


void GameScene::KeyCallback(cg3d::Viewport* _viewport, int x, int y, int key, int scancode, int action, int mods)
{
...
void GameScene::DumpMeshData(const Eigen::IOFormat& simple, const cg3d::MeshData& data)
{
...
void GameScene::AddViewportCallback(cg3d::Viewport* _viewport)
{
    viewport = _viewport;
    Scene::AddViewportCallback(viewport);
}
void GameScene::ViewportSizeCallback(cg3d::Viewport* _viewport)
{
